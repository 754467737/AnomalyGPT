...
if __name__ == "__main__":
    ...
    ds = AnomalyAnySynthDataset(run_dir=args.run_dir, image_size=args.image_size, mask_threshold=args.mask_threshold, data_root=args.data_root, obj_name=args.obj_name, seed=args.seed)
    ...
    for epoch in range(args.epochs):
        ...
        if avg < best:
            best = avg
            torch.save({"model": model.state_dict(), "args": vars(args)}, out_dir / "best.pth")
        if epoch % 10 == 0:
